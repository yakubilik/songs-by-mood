...
export default function Find({navigation}) {
    ...
    const size = Camera.Constants.pictureSize

    console.log("Resulotion",size)
    ...
    const takePictureAndroid = async()=>{
       if (camera) {
        ...
        const data = await camera.takePictureAsync(options);
          ...
          const json_to_post = { image: manipResult.base64};

          axios
          .post("https://ghpbhz7vlc.execute-api.eu-central-1.amazonaws.com/default/new_mood", json_to_post)
          .then((response) => {
      ...
      const takePicture = async () => {
        if (camera) {
          ...
          const json_to_post = { image: result.assets[0].base64 };
          axios
          .post("https://ghpbhz7vlc.execute-api.eu-central-1.amazonaws.com/default/new_mood", json_to_post)
          .then((response) => {
            succesMoodHandler(response.data);
